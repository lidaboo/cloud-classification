QUARTER_NAME = 'imageDWT';
INPUT_FOLDER = 'DWT/Tiff/Quarter/';
CLOUD_FOLDER = 'DWT/Tiff/Tiles/Cloud/';
GROUND_FOLDER = 'DWT/Tiff/Tiles/Ground/';
INDECISIVE_FOLDER = 'DWT/Tiff/Tiles/Indecisive/';
